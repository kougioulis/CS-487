...
\begin{document}
    ...
    \begin{Exercise}[2]
     	...
     	\solution \\
        \begin{enumerate}
            \item \textbf{True}. In a fully observable, turn-taking, zero-sum game is of no help to know the strategy of the opponent. This statement would be False in the case of a \textbf{\textit{partially}} observable, turn-taking, zero-sum game.
